  ...
  return (
    <div className='w-11/12 mx-auto grid grid-cols-1 md:grid-cols-5 relative'>
        ...
        <div className='md:col-span-3 lg:absolute lg:-top-60 lg:right-0'>
          <img src={heroImg} alt="hero" className='w-3/5 mx-auto md:w-full ml-15 mt-9 md:m-0' />
        </div>
        ...
        <div className='h-96 w-48 lg:h-[40rem] lg:w-200 rotate-45 lg:-rotate-45 rounded-full bg-primary -z-20 absolute -top-20 -right-20 lg:-top-[25rem] lg:-right-[15rem]'></div>
